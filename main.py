...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # button detail
        self.button_detail = customtkinter.CTkButton(master=self.frame_bottom, text="Lihat Isi Dokumen Terpilih", height=30, command=self.detail)
